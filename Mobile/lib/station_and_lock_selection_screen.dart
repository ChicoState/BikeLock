...
class station_and_lock_selection_screen extends StatefulWidget {
  station_and_lock_selection_screen(
      {Key key, this.title, BaseAuth auth, void Function() onSignOut})
      : super(key: key);
  final String title;

  @override
  _station_and_lock_selection_screenState createState() =>
      _station_and_lock_selection_screenState();
}

class _station_and_lock_selection_screenState
    extends State<station_and_lock_selection_screen> {
